...
export const publicKey = fs ? fs.readFileSync('encryptionkeys/jwt.pub', 'utf8') : process.env.PUBLIC_KEY
const privateKey = process.env.JWT_PRIVATE_KEY ?? (fs ? fs.readFileSync('encryptionkeys/jwt.key', 'utf8') : '')
